...
function LoginPage() {
  ...
  /**
   * Um usuário que já possui sessão autenticada não deve permanecer
   * na tela de login.
   */
  useEffect(() => {
    if (!authLoading && user) {
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      /**
       * O cadastro público ainda existe temporariamente.
       *
       * Ele será removido quando chegarmos à etapa definitiva de
       * gerenciamento de usuários, na qual somente Developer/Admin
       * poderão criar novas contas por um fluxo administrativo.
       */
      ...
      setErrors({
        auth: message.includes("Invalid login")
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-sidebar text-sidebar-foreground">
        ...
        <div className="space-y-4 max-w-md">
          ...
          <p className="text-sidebar-foreground/80">
            Organize pacientes, profissionais e atendimentos com clareza e
            segurança.
          </p>
        </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {mode === "signin"
                ...
                : "O cadastro público será substituído pelo gerenciamento interno de usuários."}
            </p>
          </div>
